...
int main(void)
{
    ...
    std::array<Light, MAX_LIGHTS> lights = {
        CreateLight(LIGHT_POINT, {-2, 1, -2}, Vector3Zero(), YELLOW, shader),
        CreateLight(LIGHT_POINT,  {2, 1, 2}, Vector3Zero(), RED, shader),
        CreateLight(LIGHT_POINT, {-2, 1, 2}, Vector3Zero(), GREEN, shader),
        CreateLight(LIGHT_POINT,  {2, 1, -2}, Vector3Zero(), BLUE, shader),
    };
