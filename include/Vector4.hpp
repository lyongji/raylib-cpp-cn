...
public:
    Vector4(const ::Vector4& vec) : ::Vector4{.x = vec.x, .y = vec.y, .z = vec.z, .w = vec.w} {}

    Vector4(float x, float y, float z, float w) : ::Vector4{.x = x, .y = y, .z = z, .w = w} {}
    Vector4(float x, float y, float z) : ::Vector4{.x = x, .y = y, .z = z, .w = 0} {}
    Vector4(float x, float y) : ::Vector4{.x = x, .y = y, .z = 0, .w = 0} {}
    Vector4(float x) : ::Vector4{.x = x, .y = 0, .z = 0, .w = 0} {}
    Vector4() : ::Vector4{.x = 0, .y = 0, .z = 0, .w = 0} {}
    Vector4(::Rectangle 矩形) : ::Vector4{.x = 矩形.x, .y = 矩形.y, .z = 矩形.width, .w = 矩形.height} {}
    ...
    [[nodiscard]] std::string ToString() const { return std::format("Vector4(%f, %f, %f, %f)", x, y, z, w); }
