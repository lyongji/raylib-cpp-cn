 ...
 * 检测鼠标按钮是否被按下一次
 */
[[maybe_unused]] RLCPPAPI inline bool 是否按下一次(int 按钮) {
 ...
 * 检测鼠标按钮是否正在被按下
 */
[[maybe_unused]] RLCPPAPI inline bool 是否正在按下(int 按钮) {
 ...
 * 检测鼠标按钮是否被释放一次
 */
[[maybe_unused]] RLCPPAPI inline bool 是否被释放一次(int 按钮) {
  return ::IsMouseButtonReleased(按钮);
}

[[maybe_unused]] RLCPPAPI inline bool 是否未被按下(int 按钮) {
  return ::IsMouseButtonUp(按钮);
}

[[maybe_unused]] RLCPPAPI inline int 取X坐标() { return ::GetMouseX(); }

[[maybe_unused]] RLCPPAPI inline int 取Y坐标() { return ::GetMouseY(); }

[[maybe_unused]] RLCPPAPI inline void 设X坐标(int x) {
  ::SetMousePosition(x, 取Y坐标());
}

[[maybe_unused]] RLCPPAPI inline void 设Y坐标(int y) {
  ::SetMousePosition(取X坐标(), y);
}
 ...
 * 获取鼠标在帧之间的增量,取鼠标移动差值
 */
[[maybe_unused]] RLCPPAPI inline Vector2 取移动差值() {
...
[[maybe_unused]] RLCPPAPI inline void 设缩放(float 缩放X = 1.0f,
                                             float 缩放Y = 1.0f) {
 ...
 */
[[maybe_unused]] RLCPPAPI inline float 取滚轮移动量() {
 ...
 * 从鼠标位置获取光线追踪
 */
[[maybe_unused]] RLCPPAPI inline Ray 取射线(::Vector2 鼠标位置,
                                            const ::Camera &相机) {
