...
public:
     ...
     * 从另一个包围盒复制一个包围盒。
     */
    包围盒(const ::BoundingBox& 包围盒实例) : ::BoundingBox{包围盒实例.min, 包围盒实例.max} {
        // 无操作
    }
    ...
    包围盒(::Vector3 边界值 = ::Vector3{0.0f, 0.0f, 0.0f}) : ::BoundingBox{边界值, 边界值} {}
     ...
     * 用线条绘制一个包围盒
     */
    void 绘制包围盒(::Color 颜色 = {255, 255, 255, 255}) const { ::DrawBoundingBox(*this, 颜色); }
