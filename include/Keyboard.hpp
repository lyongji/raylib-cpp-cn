 ...
 * 检测某个键是否被按下一次
 */
[[maybe_unused]] RLCPPAPI inline bool 是否按下一次(int 按键) {
 ...
 */
[[maybe_unused]] RLCPPAPI inline bool 是否再次按下(int 按键) {
 ...
 * 检测某个键是否正在被按下
 */
[[maybe_unused]] RLCPPAPI inline bool 是否正在按下(int 按键) {
  return ::IsKeyDown(按键);
}
 ...
 * 检测某个键是否被释放一次
 */
[[maybe_unused]] RLCPPAPI inline bool 是否被释放一次(int key) {
 ...
 * 检测某个键是否没有被按下
 */
[[maybe_unused]] RLCPPAPI inline bool 是否未被按下(int key) {
  return ::IsKeyUp(key);
}
