...
public:
    颜色(const ::Color& 颜色) : ::Color{.r = 颜色.r, .g = 颜色.g, .b = 颜色.b, .a = 颜色.a} {}
    ...
    [[nodiscard]] std::string ToString() const { return std::format("颜色(%d, %d, %d, %d)", r, g, b, a); }
     ...
     */
    [[nodiscard]] 颜色 设透明度(float 透明度) const { return ::Fade(*this, 透明度); }
    ...
    bool 是否同色(::Color 颜色) { return ::ColorIsEqual(*this, 颜色); }
    ...
    颜色 插值(::Color 另一颜色, float 系数) { return ::ColorLerp(*this, 另一颜色, 系数); }
