...
public:
   ...
   */
  [[nodiscard]] Vector2 取屏幕到世界(::Vector2 屏幕坐标) const {
    return ::GetScreenToWorld2D(屏幕坐标, *this);
  }

  /**
   * 返回 2D 世界空间位置对应的 2D 屏幕空间位置
   */
  [[nodiscard]] Vector2 取世界到屏幕(::Vector2 世界坐标) const {
    return ::GetWorldToScreen2D(世界坐标, *this);
  }
