...
public:
    矩形(const ::Rectangle& 矩形) : ::Rectangle{矩形.x, 矩形.y, 矩形.width, 矩形.height} {}
    ...
    矩形(::Vector2 位置, ::Vector2 大小) : ::Rectangle{位置.x, 位置.y, 大小.x, 大小.y} {}
    ...
    void 绘制(::Vector2 原点, float 旋转, ::Color 颜色) const { ::DrawRectanglePro(*this, 原点, 旋转, 颜色); }

    /// 绘制垂直渐变矩形
    void 绘制垂直渐变(::Color 颜色1, ::Color 颜色2) const {
    ...
    /// 绘制水平渐变矩形
    void 绘制水平渐变(::Color 颜色1, ::Color 颜色2) const {
    ...
    /// 绘制四角渐变矩形
    void 绘制四角渐变(::Color 左上, ::Color 左下, ::Color 右上, ::Color 右下) const {
    ...
    /// 绘制矩形边框，指定线宽
    void 绘制边框(::Color 颜色, float 线宽) const { ::DrawRectangleLinesEx(*this, 线宽, 颜色); }

    /// 绘制圆角矩形
    void 绘制圆角矩形(float 圆度, int 段数, ::Color 颜色) const { ::DrawRectangleRounded(*this, 圆度, 段数, 颜色); }
